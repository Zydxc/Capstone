...
<head>
    ...
    <title>Personal Preclassification - Sign up</title>
                ...
                <div class="login-card">
                    ...
                    <div class="mt-3">
                        <form action="process.php" method="POST">
                            <input type="text" placeholder="Username" name="user" class="form-control input-login w-50" required>
                            <br>
                            ...
                            <br>
                            <input type="password" name="pass2" placeholder="Retype Password" class="form-control input-login w-50"
                                required>
                            <br>
                            <button type="submit" name="register" class="login-button w-25">Sign up</button>
                        </form>
                    </div>
